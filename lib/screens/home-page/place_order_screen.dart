...
class _PlaceOrderState extends State with SingleTickerProviderStateMixin  {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Confriming Order",style: TextStyle(color: Colors.cyanAccent),),
        backgroundColor: Colors.transparent,
        elevation: 0, // Removes the shadow from the app bar
        leading: Padding(
          padding: const EdgeInsets.all(8.0), // Padding around the button for a nicer look
          child: FloatingActionButton(
            onPressed: () {
              // Action to go back
              Navigator.of(context).pop();
            },
            child: Icon(Icons.arrow_back, color: Colors.black), // Icon inside the button
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Total fare :${fareInt + taxAmt - 5}', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.cyanAccent)),
                    SizedBox(width: 20,),
                    Row(
                      children: [
                        Text('Total Distance : ${tripDirectionDetailsInfo?.distance_text}', style: TextStyle(fontSize: 16, color: Colors.blue)),
                        SizedBox(width: 20,),
                        Text('Estd Time :${tripDirectionDetailsInfo?.duration_text}', style: TextStyle(fontSize: 16, color: Colors.blue)),
                      ],
                    ),
                    ...
                    _buildLocationSection(
                        Icons.my_location, "Pickup Location",Provider.of<AppInfo>(context)
                        .userPickUpLocation!
                        .locationName!,
                        Colors.blue),
                    SizedBox(height: 10.0),
                    _buildLocationSection(
                        Icons.place, "Dropoff Location",  Provider.of<AppInfo>(context)
                        .userDropOffLocation!
                        .locationName!,
                        Colors.red),
                    SizedBox(height: 20.0),
    ...
    return const Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            Text('Vehicle Details', style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold)),
            Divider(),
            Row(
              children: [
  ...
  Widget _buildLocationSection(IconData icon, String label, String address,
      Color iconColor) {
    return Row(
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(label,
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              Text(address, style: TextStyle(fontSize: 14),overflow: TextOverflow.ellipsis,softWrap: true,maxLines: 2,),
            ],
          ),
        ),
      ],
